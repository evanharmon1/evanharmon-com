...
export const footerData = {
  ...
  socialLinks: [
    ...
    { ariaLabel: 'LinkedIn', icon: 'tabler:brand-linkedin', href: 'https://linkedin.com/in/evanharmon1/' },
    { ariaLabel: 'Mastodon', icon: 'tabler:brand-mastodon', href: 'https://mastodon.social/@evanharmon' },
    { ariaLabel: 'X', icon: 'tabler:brand-x', href: 'https://twitter.com/evanharmon' },
